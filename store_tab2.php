...
<body>
    <div class="main_container">
        ...
        <div class="sort_select"> <a class="sort_select__button" href="" id="sort_select"
                onclick="event.preventDefault()"><span id="sort_an">Оправы для
                    зрения</span></a></div>

        <div class="sort" id="sort">
            <a href="/store.php" class="sort__container__text">Солнцезащитные очки</a>
            <a class="sort__container__text sort__container__text_1" style="background: #d7afaf;">Оправы для зрения</a>
            <a href="/store_tab3.php" class="sort__container__text">Коллекционные</a>
        </div>
